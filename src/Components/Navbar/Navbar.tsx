...
const Navbar = () => {
  ...
  const handleSidebar = () => {
    ...
    homeContainer && homeContainer.classList.toggle('changePadding');
    sidebarContainer && sidebarContainer.classList.toggle('close');
  };

  const handleThemes = () => {
    const rootElement = document.getElementById('root');
    rootElement && rootElement.classList.toggle('dark-theme');
